...
namespace ImportaXml.Models
{
    ...
    {
        [Key]
        public string nfeProc_NFe_infNFe_____Id { get; set; }
        public string XmlName { get; set; }

        public string nfeProc____versao { get; set; }
        public string nfeProc____xmlns { get; set; }
        public string nfeProc_Nfe____xmlns { get; set; }
        public string nfeProc_Nfe_infNFe____versao { get; set; }




        public int nfeProc_NFe_infNFe_ide_cUF { get; set; }
        public string nfeProc_NFe_infNFe_ide_cNF { get; set; }
        public string nfeProc_NFe_infNFe_ide_natOp { get; set; }
        public int nfeProc_NFe_infNFe_ide_mod { get; set; }
        public int nfeProc_NFe_infNFe_ide_serie { get; set; }
        public double nfeProc_NFe_infNFe_ide_nNF { get; set; }
        public string nfeProc_NFe_infNFe_ide_dhEmi { get; set; } //DateTime
        public string nfeProc_NFe_infNFe_ide_dhSaiEnt { get; set; } //DateTime
        public int nfeProc_NFe_infNFe_ide_tpNF { get; set; }
        public int nfeProc_NFe_infNFe_ide_idDest { get; set; }
        public string nfeProc_NFe_infNFe_ide_cMunFG { get; set; }
        public int nfeProc_NFe_infNFe_ide_tpImp { get; set; }
        public int nfeProc_NFe_infNFe_ide_tpEmis { get; set; }
        public int nfeProc_NFe_infNFe_ide_cDV { get; set; }
        public int nfeProc_NFe_infNFe_ide_tpAmb { get; set; }
        public int nfeProc_NFe_infNFe_ide_finNFe { get; set; }
        public int nfeProc_NFe_infNFe_ide_indFinal { get; set; }
        public int nfeProc_NFe_infNFe_ide_indPres { get; set; }
        public int nfeProc_NFe_infNFe_ide_indIntermed { get; set; }
        public int nfeProc_NFe_infNFe_ide_procEmi { get; set; }
        ...
        public int nfeProc_NFe_infNFe_emit_enderEmit_nro { get; set; }
        ...
        public int nfeProc_NFe_infNFe_emit_CRT { get; set; }
        ...
        public int nfeProc_NFe_infNFe_dest_enderDest_nro { get; set; }
        ...
        public int nfeProc_NFe_infNFe_dest_indIEDest { get; set; }
        ...
        public int nfeProc_NFe_infNFe_retirada_nro { get; set; }
        ...
        public int nfeProc_NFe_infNFe_entrega_nro { get; set; }
        ...
        public double nfeProc_NFe_infNFe_total_ICMSTot_vBC { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vICMS { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vICMSDeson { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vFCPUFDest { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vICMSUFDest { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vICMSUFRemet { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vFCP { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vBCST { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vST { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vFCPST { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vFCPSTRet { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vProd { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vFrete { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vSeg { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vDesc { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vII { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vIPI { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vIPIDevol { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vPIS { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vCOFINS { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vOutro { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vNF { get; set; }
        public double nfeProc_NFe_infNFe_total_ICMSTot_vTotTrib { get; set; }



        public int nfeProc_NFe_infNFe_total_transp_modFrete { get; set; }
        ...
        public int nfeProc_NFe_infNFe_total_transp_vol_qVol { get; set; }
        public string nfeProc_NFe_infNFe_total_transp_vol_marca { get; set; }
        public double nfeProc_NFe_infNFe_total_transp_vol_pesoL { get; set; }
        public double nfeProc_NFe_infNFe_total_transp_vol_pesoB { get; set; }




        public double nfeProc_NFe_infNFe_total_cobr_fat_nFat { get; set; }
        public double nfeProc_NFe_infNFe_total_cobr_fat_vOrig { get; set; }
        public double nfeProc_NFe_infNFe_total_cobr_fat_vDesc { get; set; }
        public double nfeProc_NFe_infNFe_total_cobr_fat_vLiq { get; set; }

        public string nfeProc_NFe_infNFe_total_cobr_dup_nDup { get; set; }
        public string nfeProc_NFe_infNFe_total_cobr_dup_dVenc { get; set; } //DateTime
        public double nfeProc_NFe_infNFe_total_cobr_dup_vDup { get; set; }



        public int nfeProc_NFe_infNFe_total_pag_detPag_indPag { get; set; }
        public int nfeProc_NFe_infNFe_total_pag_detPag_tPag { get; set; }
        public double nfeProc_NFe_infNFe_total_pag_detPag_vPag { get; set; }
        ...
        public string nfeProc_NFe_Signature____xmlns { get; set; }
        public string nfeProc_NFe_Signature_SignedInfo____xmlns { get; set; }
        public string nfeProc_NFe_Signature_SignedInfo_CanonicalizationMethod____Algorithm { get; set; } 
        public string nfeProc_NFe_Signature_SignedInfo_SignatureMethod____Algorithm { get; set; } 
        public string nfeProc_NFe_Signature_SignedInfo_Reference____URI { get; set; }
        //Algorithms
        public string nfeProc_NFe_Signature_SignedInfo_Reference_DigestMethod____Algorithm { get; set; }
        ...
        public string nfeProc_protNFe____versao { get; set; }
        ...
        public int nfeProc_protNFe_infProt_tpAmb { get; set; }
        public string nfeProc_protNFe_infProt_verAplic { get; set; }
        public string nfeProc_protNFe_infProt_chNFe { get; set; }
        public string nfeProc_protNFe_infProt_dhRecbto { get; set; } //DateTime
